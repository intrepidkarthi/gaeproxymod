...
public class GAEProxy extends PreferenceActivity implements
	...
	private boolean isProxyDNS = true;
	...
	private CheckBoxPreference isProxyDNSCheck;
	...
	private void disableAll() {
		...
		isProxyDNSCheck.setEnabled(false);
	}
	...
	private void enableAll() {
		...
		isProxyDNSCheck.setEnabled(true);
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		isProxyDNSCheck = (CheckBoxPreference)findPreference("dns");
...
//						Date date = new Date();
						...
						if (!Utils.isFile("/data/data/org.gaeproxy/hosts")
								|| Utils.compareTime(
										settings.getLong("timeStamp", 0),
										timestamp) > 1) {
							URL aURL = new URL(
									"http://myhosts.sinaapp.com/hosts");
	...
	public boolean serviceStart() {
		...
		isProxyDNS = settings.getBoolean("dns", true);
		...
		try {
			...
			bundle.putBoolean("dns", isProxyDNS);
